...
function NavBar({ theme, onThemeSwitch }) {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-5 z-50 flex w-screen flex-col items-center justify-center"
    >
      <motion.div
        className="
          flex w-full items-center justify-between overflow-y-hidden p-2
          backdrop-blur-md lg:w-[50rem] rounded-full shadow-md border font-semibold
          dark:border-navBg-dark dark:bg-navBg-dark/70 bg-navBg-light/70
          dark:text-primaryText-dark border-navBg-light text-primaryText-light"
      >
